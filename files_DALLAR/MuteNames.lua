...
if DevAbs:get(DALLAR.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(DALLAR.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(DALLAR.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(DALLAR.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(DALLAR.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(DALLAR.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DALLARName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DALLARName then 
DALLARNames = DevAbs:smembers(DALLAR.."Abs:Mute:Names"..msg.chat_id_) or ""
if DALLARNames and DALLARNames[1] then 
for i=1,#DALLARNames do 
if DALLARName:match("(.*)("..DALLARNames[i]..")(.*)") then 
...
DevAbs:set(DALLAR.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(DALLAR.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
