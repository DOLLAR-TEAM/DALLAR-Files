...
if DevAbs:get(DALLAR.."Abs:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Ali_DALLAR(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAbs:setex(DALLAR..'Abs:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
